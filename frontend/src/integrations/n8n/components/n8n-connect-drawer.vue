        ...
        <ul class="list-none space-y-4">
          ...
          <li class="flex items-start">
            ...
            <p class="ml-4 text-gray-900 text-xs">
              Go to
              <a
                href="https://n8n.io/integrations/crowddev/"
                target="_blank"
                rel="noopener noreferrer"
                class="underline underline-offset-4"
              >n8n</a>
          ...
          <li class="flex items-center">
            ...
            <p class="ml-4 text-gray-900 text-xs">
              ...
              <a
                href="https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.crowddev/"
                target="_blank"
                rel="noopener noreferrer"
                class="underline underline-offset-4"
              >supported
...
const logoUrl = CrowdIntegrations.getConfig('n8n').image;
